package com.Desafio.Unidac.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.Desafio.Unidac.controller")).paths(PathSelectors.any())
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Desafio Unidac").description("Projeto API Spring - Cafe da manha")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("http://localhost:8080/swagger-ui/")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Beatriz Rodrigues", "https://github.com/beatriz-rodrig",
